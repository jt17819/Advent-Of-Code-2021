# -*- coding: utf-8 -*-
"""
Created on Sat Dec 18 12:45:03 2021
...
filename = 'codedata.txt'

data = str(np.loadtxt(filename, delimiter=',', dtype=str))
print(data)

scale = 16
res = bin(int(data, scale)).zfill(8)
print(res)
...
def get_value(data, pos):
    ...
    if type_id == 4:
        ...
        if type_id == 0:
            ...
            return math.prod(sub_packets), pos_change
        elif type_id == 2:
